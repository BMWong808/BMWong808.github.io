...
function getUserData(redirect) {
  ...
  makeRequest("/api/getUserData", { userID: userID, token: token }).then(
    (data) => {
      if (data.success) {
...
function loginPageEvents() {
  ...
  $("#registerButton").on("click", () => {
    ...
    makeRequest("/register", {
      ...
      (err) => {
        $("#registerError").text(
          "Error: Connection to the server was rejected.",
        );
      },
    );
  });
...
function scheduleEvents() {
  let data = [
    {
      id: "timelineTeamBuilding",
      title: "Team Building Event",
      date: " ⁠— Fri 17:00 - 20:00",
      desc: `This event will be for finding other group members to add to your team. `,
    },
    {
      id: "timelineInduction",
      title: "Induction  ",
      date: " ⁠— Sat 11:00 - 12:00",
